...
{
	public static class ConfirmOverwritePopup
	{
		private static Action<bool> onClosedCallback;

		public static void DrawMenu()
		{
			MenuHelper.DrawBackgroundOverlay();

			string text = $"A project with that name already exists.\nAre you sure you want to overwrite it?";
		...
		public static void OpenPopup(Action<bool> callback)
		{
			...
			UIDrawer.SetActiveMenu(UIDrawer.MenuType.Overwrite);
		}
	}
